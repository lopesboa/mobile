...
import {Cards, DisciplineCard, ChapterCard, ScormCard, Card, CardLevel, Completion} from './_types';
...
export const cardsToKeys = (
  ...
  [key: string]: DisciplineCard | ChapterCard | ScormCard;
} => {
