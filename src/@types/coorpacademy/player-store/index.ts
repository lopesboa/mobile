...
export type {
    FindCorrection,
    AnswersService
} from './definitions/services/answers';
export type {
    FindById as FindClueById,
    CluesService
} from './definitions/services/clues';
...
export type {
    ...
    SlidesService
} from './definitions/services/slides';
export type {
    FindUriById as FindVideoUriById,
    VideosService
} from './definitions/services/videos';
