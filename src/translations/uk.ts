...
const translations: Translations = {
  ...
  finishCourseWordings: [
    {
      title: 'Настав час (повторно) запустити {{givenName}}! 🚀',
      description: 'Пройдіть цей курс: {{contentName}}',
    },
    {
      title: 'Ваша місія, якщо ви приймете її 😎',
      description: 'Закінчіть свій курс {{contentName}}',
    },
    {
      title: '{{givenName}}, закладаюся, що ви можете це зробити! 💪',
      description: 'Закінчіть курс {{contentName}}',
    },
    {
      title: 'Вам потрібна перерва, {{givenName}}? 🤯',
      description: 'Давайте завершимо {{contentName}}',
    },
    {
      title: '{{givenName}}, ви розпочали свій курс 2 дні тому ⏳',
      description: 'завершіть {{contentName}}',
    },
    {title: 'Прийміть виклик, {{givenName}} 💪', description: 'Пройдіть курс {{contentName}}'},
    {
      title: 'Ви приземлилися, {{givenName}}? 🤯',
      description: 'Розслабтеся і знайдіть кілька хвилин, щоб завершити {{contentName}}',
    },
    {title: '{{givenName}}, навіть не заголовок 😉', description: 'Завершіть {{contentName}}'},
    {title: 'Ваш добрий вчинок тижня! 😇', description: 'Пройдіть курс {{contentName}}'},
    {
      title: 'Те, що зроблено, більше не має робитися 🙃',
      description: 'Пройдіть курс {{contentName}}',
    },
    {title: 'Готово! ✓ Майже...', description: 'Пройдіть курс {{contentName}}'},
    {
      title: '{{givenName}}, ви так близько! 🙃',
      description: 'Має бути вирішено більше ніж кілька питань {{contentName}}',
    },
    {
      title: 'Давай, {{givenName}}! Майже закінчено ☑️',
      description: 'Пройдіть свій курс {{contentName}}',
    },
  ],
