...
const translations: Translations = {
  ...
  authorizeNotifications: 'Autoryzuj powiadomienia',
  ...
  gameOver: 'Koniec gry',
  getAnExtralife: 'Zdobądź dodatkowe życie wyświetlając lekcję',
  goodAnswer: 'Dobra odpowiedź',
  ...
  resumeLearning: 'Kontynuować naukę',
  ...
  upgrade: 'Ulepsz',
  upgradeDescription:
    'Aplikacja została zaktualizowana! Pobierz najnowszą wersję, aby z niej korzystać.',
  winAdditionalStars:
