...
const translations: Translations = {
  ...
  finishCourseWordings: [
    {
      title: 'Время (пере)запуска, {{givenName}}! 🚀',
      description: 'Пройдите этот курс: {{contentName}}',
    },
    {
      title: 'Ваша миссия, если вы решите принять ее 😎',
      description: 'Закончите курс {{contentName}}',
    },
    {
      title: '{{givenName}}, спорим, Вы сможете это сделать! 💪',
      description: 'Закончите курс {{contentName}}',
    },
    {title: 'Нужен перерыв, {{givenName}}? 🤯', description: 'Давайте пройдем {{contentName}}'},
    {
      title: '{{givenName}}, вы начали свой курс два дня назад ⏳',
      description: 'Пройти {{contentName}}',
    },
    {title: 'Примите вызов, {{givenName}} 💪', description: 'Пройдите курс {{contentName}}'},
    {
      title: 'Вы достигли цели, {{givenName}}? 🤯',
      description: 'Расслабьтесь и дайте себе несколько минут, чтобы пройти {{contentName}}',
    },
    {title: '{{givenName}}, даже не стремитесь 😉', description: 'Пройдите {{contentName}}'},
    {title: 'Ваше доброе дело на этой неделе! 😇', description: 'Пройдите курс {{contentName}}'},
    {
      title: 'Что сделано, то больше делать не нужно 🙃',
      description: 'Пройдите курс {{contentName}}',
    },
    {title: 'Готово! ✓ Почти...', description: 'Пройдите курс {{contentName}}'},
    {
      title: '{{givenName}}, Вы так близки к цели! 🙃',
      description: 'До завершения {{contentName}} осталось немало вопросов',
    },
    {
